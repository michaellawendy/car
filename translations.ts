...
export const translations: Translations = {
  ...
  [Language.AR]: {
    ...
    deleteVehicleConfirm: "هل أنت متأكد أنك تريد حذف هذه المركبة وجميع سجلاتها؟",
    ...
    addYourFirstVehicle: "أضف مركبتك الأولى",
    noVehiclesYet: "لا توجد مركبات بعد!",
    noVehiclesMessage: "أضف مركبتك الأولى لبدء تتبع الصيانة.",
    backToVehicleList: "العودة إلى قائمة المركبات",
    ...
    addRecord: "إضافة سجل",
    noMaintenanceRecordsForVehicle: "لا توجد سجلات صيانة لهذه المركبة حتى الآن.",
